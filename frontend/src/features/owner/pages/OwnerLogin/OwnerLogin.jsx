    ...
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        <div className={styles.footer}>
          <p>Don't have an account? <a href="/owner/register" className={styles.link}>Register here</a></p>
          <p>Forget Pin? <a href="/owner/createnewpin" className={styles.link}>Click here</a></p>
        </div>
      </div>
    </div>
  )
